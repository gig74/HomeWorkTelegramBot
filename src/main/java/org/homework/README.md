...
При возникновении любого исключения  (например, при ошибке регистрации бота), ошибка выводится в стандартный поток ошибок с помощью `e.printStackTrace()`.

## Навигация

Для получения информации о структуре проекта, инструкциях по разработке и документации по использованным библиотекам и фреймворкам, пожалуйста, перейдите к основному [README.md](../../../../../README.md) файлу в корневой директории проекта `HomeWorkTelegramBot`.
